...
+ Metodi operativi {#operation-methods}
   ...
   + Parametri operativi {#operation-parameters}
      ...
      + [rinominaRisorsa](operations/c-operations-intro/c-methods/r-rename-asset.md)
      + [rinominaCartella](operations/c-operations-intro/c-methods/r-rename-folder.md)
      + [rinominaProgetto](operations/c-operations-intro/c-methods/r-rename-project.md)
      ...
      + [curriculumJob](operations/c-operations-intro/c-methods/r-resume-job.md)
...
+ Tipi di dati {#data-types}
   ...
   + [CampiMetadatiRisorsa](types/c-data-types/r-asset-metadata-fields.md)
   + [ArrayCampiMetadatiRisorsa](types/c-data-types/r-asset-metadata-fields-array.md)
   ...
   + [AttivitàGenerazioneAutomatizzata](types/c-data-types/r-automated-set-generation-job.md)
   + [OpzioniCreazioneImpostazioneAutomatica](types/c-data-types/r-auto-set-creation-options.md)
   + [OpzioniRitaglioAutomaticoTrasparente](types/c-data-types/r-auto-transparent-crop-options.md)
   + [AggiornamentoMetadatiBatch](types/c-data-types/r-batch-metadata-update.md)
   ...
   + [Appartenenza alla società](types/c-data-types/r-company-membership.md)
   + [CompanyMembershipArray](types/c-data-types/r-company-membership-array.md)
   + [AggiornamentoIscrizioneSocietà](types/c-data-types/r-company-membership-update.md)
   ...
   + [Utilizzo disco](types/c-data-types/r-disk-usage.md)
   ...
   + [Registro processi](types/c-data-types/r-job-log.md)
   + [JobLogArray](types/c-data-types/r-job-log-array.md)
   + [DettagliRegistroLavoro](types/c-data-types/r-job-log-detail.md)
   + [MatriceLogDettaglioProcesso](types/c-data-types/r-job-log-detail-array.md)
   ...
   + [InformazioniVisualizzazioneLivello](types/c-data-types/r-layer-view-info.md)
   + [OpzioniRitaglioManuale](types/c-data-types/r-manual-crop-options.md)
   ...
   + [InformazioniVideoMaster](types/c-data-types/r-master-video-info.md)
   ...
   + [CampoMetadati](types/c-data-types/r-metadata-field.md)
   ...
   + [OttimizzaImmaginiJob](types/c-data-types/r-optimize-images-job.md)
   ...
   + [Opzioni Photoshop](types/c-data-types/r-photoshop-options.md)
   + [OpzioniLivelloPhotoshop](types/c-data-types/r-photoshop-layer-options.md)
   + [PostScriptInfo](types/c-data-types/r-post-script-info.md)
   + [OpzioniPostScript](types/c-data-types/r-post-script-options.md)
   ...
   + [DecomprimiOpzioni](types/c-data-types/r-uncompress-options.md)
   + [OpzioniMascheraDiDiscesa](types/c-data-types/r-unsharp-mask-options.md)
   ...
   + [InformazioniFiligrana](types/c-data-types/r-watermark-info.md)
   ...
   + [Parole chiave Xmp](types/c-data-types/r-xmp-keywords.md)
...
+ Costanti stringa {#sting-constants}
   ...
   + [Campi di ordinamento delle risorse](string-constants/c-string-constants/r-asset-sort-fields.md)
   + [Tipi di risorse](string-constants/c-string-constants/r-asset-types.md)
   + [Angolo ritaglio automatico](string-constants/c-string-constants/r-auto-crop-corner.md)
   ...
   + [Campi di ordinamento del registro dei processi](string-constants/c-string-constants/r-job-log-sort-fields.md)
   + [Tipi di log dei processi](string-constants/c-string-constants/r-job-log-types.md)
   + [Stati trigger processo](string-constants/c-string-constants/r-job-trigger-states.md)
   ...
   + [Tipi di autorizzazioni](string-constants/c-string-constants/r-permission-types.md)
   + [Modalità di ancoraggio Photoshop](string-constants/c-string-constants/r-photoshop-anchor-modes.md)
   + [Modalità di denominazione dei livelli Photoshop](string-constants/c-string-constants/r-photoshop-layer-naming-modes.md)
   + [Modalità a colori PostScript](string-constants/c-string-constants/r-postscript-colorspace-modes.md)
   + [Classi di profilo](string-constants/c-string-constants/r-profile-classes.md)
   + [Stato di pubblicazione](string-constants/c-string-constants/r-publish-state.md)
   ...
   + [Forma area](string-constants/c-string-constants/r-region-shape.md)
   + [Modalità di ricerca](string-constants/c-string-constants/r-search-match-modes.md)
   + [Ordina direzioni](string-constants/c-string-constants/r-sort-directions.md)
   + [Operatori di confronto delle stringhe](string-constants/c-string-constants/r-string-comparison-operators.md)
   + [Stato del cestino](string-constants/c-string-constants/r-trash-state.md)
...
+ Cambia registro {#change-log}
   ...
   + Versione 3.7 {#version-3-7}
      ...
      + [Costanti stringa: Nuovo e modificato](change-log/c-change-log/c-3-7/r-3-7-string-constants.md)
+ [Caricamento delle risorse tramite POST HTTP in UploadFile in corso...](c-http-post.md)
