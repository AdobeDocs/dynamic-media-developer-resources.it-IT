...
+ Metodi di operazione {#operation-methods}
   + [Metodi delle operazioni](operations/c-operations-intro/c-operations-intro.md)
   + Parametri di funzionamento {#operation-parameters}
      + [Panoramica sui parametri di operazione](operations/c-operations-intro/c-methods/c-methods.md)
...
+ Tipi di dati {#data-types}
   ...
   + [EmailConfirm](types/c-data-types/r-email-confirmation.md)
   ...
   + [AnnullaComprimiOpzioni](types/c-data-types/r-uncompress-options.md)
   ...
   + [FiligranaInfo](types/c-data-types/r-watermark-info.md)
...
+ Costanti stringa {#sting-constants}
   ...
   + [Modalità di sovrascrittura risorse](string-constants/c-string-constants/r-asset-overwrite-modes.md)
   + [Campi ordinamento risorse](string-constants/c-string-constants/r-asset-sort-fields.md)
   + [Tipi di risorse](string-constants/c-string-constants/r-asset-types.md)
   + [Angolo di ritaglio automatico](string-constants/c-string-constants/r-auto-crop-corner.md)
   ...
   + [Tipi di processo](string-constants/c-string-constants/r-job-types.md)
   ...
   + [Pubblica stato](string-constants/c-string-constants/r-publish-state.md)
   ...
   + [Modalità di corrispondenza ricerca](string-constants/c-string-constants/r-search-match-modes.md)
...
+ Errori {#faults}
   ...
   + [permissionsFault](faults/c-faults/r-authorization-fault.md)
...
+ [Caricamento delle risorse tramite POST HTTP nel file UploadFile in corso...](c-http-post.md)
