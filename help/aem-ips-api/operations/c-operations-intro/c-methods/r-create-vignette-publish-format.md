...
I formati delle vignettature specificano le dimensioni delle vignettature pubblicate e le relative miniature, nonché i livelli di zoom, i parametri di nitidezza e la versione del formato file per le vignettature prodotte dalle vignettature principali pubblicate su un server di rendering immagini da IPS.
...
<table id="table_4D5B2913FA784EC09190F25223C1A680"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> crea piramide</span></span> </td> 
   <td colname="col2"> <span class="codeph"> Frase codice </span> </td> 
   <td colname="col3"> Sì </td> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> rendere <span class="varname"> più nitido</span></span> </td> 
   <td colname="col2"> <span class="codeph"> Frase codice </span> </td> 
