...
seo-description: Definisce un target di pubblicazione per una società.
...
Definisce un target di pubblicazione per una società.

Sintassi

## Parametri {#section-577d46cc75774c7c8fbdcff203a0d9ac}

Le risorse mantengono un marcatore separato per ogni stato e contesto di pubblicazione. Imposta lo stato di pubblicazione con [setAssetsContextState](../../operations/c-operations-intro/c-methods/r-set-asset-context-state.md#reference-da96f9caef734f2883fddaf58cd886d7).
