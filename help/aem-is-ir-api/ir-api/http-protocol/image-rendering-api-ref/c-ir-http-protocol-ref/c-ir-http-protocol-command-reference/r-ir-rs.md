...
Utilizzato per ottimizzare l’aspetto del rendering. Per creare le stringhe delle impostazioni di rendering, usate la funzione di rendering dello strumento di authoring delle vignettature (parte del pacchetto Scene7 Image Authoring).
