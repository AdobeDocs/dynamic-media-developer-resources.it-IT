...
description: Questi comandi vengono utilizzati per selezionare gruppi di vignettatura, oggetti, sottoaree di gruppi o oggetti.
...
Questi comandi vengono utilizzati per selezionare gruppi di vignettatura, oggetti, sottoaree di gruppi o oggetti.

Il comando o il materiale, o entrambi, vengono specificati dopo questo comando di selezione e prima che il comando di selezione successivo (o la fine della richiesta) venga applicato all&#39;elemento selezionato. I comandi di selezione delimitano i segmenti di specifica materiale (MSS).
...
<table id="simpletable_028957E516644FE8A7B1BC056A32FCD1"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Selezionate un gruppo di vignettatura o un oggetto in base al nome. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Selezionate un gruppo di vignettatura o un oggetto in base alla posizione in pixel. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-decal.md#reference-3a5f1adc7fe24c91aa5655d64038e857" type="reference" format="dita" scope="local"> decalcomania</a></span> </p></td> 
