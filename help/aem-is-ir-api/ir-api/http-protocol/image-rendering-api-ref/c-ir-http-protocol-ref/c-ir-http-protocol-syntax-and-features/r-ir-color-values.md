...
Valori colore per `color=` e `bgc=` gli attributi possono essere specificati utilizzando un elenco di valori di componenti decimali e separati da virgole o una notazione esadecimale, simile a HTML.
...
Alcuni esempi di specifiche di colore valide e la relativa interpretazione del valore di colore RGB:
