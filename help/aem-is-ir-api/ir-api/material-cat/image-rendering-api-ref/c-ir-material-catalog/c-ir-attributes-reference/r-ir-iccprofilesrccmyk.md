...
Ereditato da `default::IccProfileSrcCmyk` se non definito o se vuoto. Se `attribute::IccProfileSrcCmyk` non si risolve in un profilo valido, `attribute::IccProfileCmyk` verrà utilizzato al posto.
