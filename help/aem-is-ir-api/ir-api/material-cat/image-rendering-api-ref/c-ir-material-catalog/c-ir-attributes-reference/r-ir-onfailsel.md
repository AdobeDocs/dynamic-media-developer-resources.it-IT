...
Gestione degli errori di selezione. Specifica l&#39;azione da eseguire se `sel=` il comando ha esito negativo perché la posizione in pixel specificata non si trova nell&#39;area della maschera di un oggetto selezionabile.
...
Ereditato da `default::OnFailSel` se non è definita.
