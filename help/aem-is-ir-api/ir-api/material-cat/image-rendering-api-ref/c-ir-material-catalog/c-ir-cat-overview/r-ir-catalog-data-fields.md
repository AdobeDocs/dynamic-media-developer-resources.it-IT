...
seo-description: Sono disponibili i seguenti campi di dati del catalogo.
seo-title: Campi dati del catalogo
...
<table id="simpletable_C2D795844F624470871959842AF50BF3"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Scadenza cache client (intervallo di tempo per il ciclo di vita). </p></td> 
 </tr> 
</table>

<table id="simpletable_58980295E92848B7BE471855D629F756"> 
 <thead class="sthead"> 
  <td class="stentry"> <p>Attributi del materiale </p></td> 
  <td class="stentry"> <p>Descrizione </p></td> 
 </thead> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Percorso o URL del file di dati immagine. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Percorso file di dati secondario o URL. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-resolution-dataref.md#reference-6a2d64c2d72b438fade58a3391569da7" type="reference" format="dita" scope="local"> Risoluzione </a> </p></td> 
  <td class="stentry"> <p>Risoluzione dell'immagine. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-anchor.md#reference-d9b1d49db1fc440686f64b84453297ab" type="reference" format="dita" scope="local"> Ancoraggio </a> </p></td> 
  <td class="stentry"> <p>Punto di ancoraggio texture/decal (punto di attivazione). </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Colore sottrattivo per un materiale colorizzabile. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Selettore mappa illuminazione. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-gloss.md#reference-5277f62a67e2408ab94699aa712f1eeb" type="reference" format="dita" scope="local"> Glossario</a> </p></td> 
  <td class="stentry"> <p>Lucidità superficiale. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-sharp-dataref.md#reference-f79a14bd52474dfd8495115d398a30d0" type="reference" format="dita" scope="local"> Brillante</a> </p></td> 
  <td class="stentry"> <p>Nitidezza texture/decal. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-repeat.md#reference-20e149211e1f4e8285db5ecb83c1902e" type="reference" format="dita" scope="local">Repeat</a> (Ripeti) </p></td> 
  <td class="stentry"> <p>Modalità di ripetizione per texture ripetibili. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-alignment.md#reference-e52152e8dc244d0aa13b40c615d0f399" type="reference" format="dita" scope="local"> Allineamento</a> </p></td> 
  <td class="stentry"> <p>Allineamento della texture tra gli oggetti. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-cat-size.md#reference-a698b0d2652f4ea8a2b006fbf59cf4f1" type="reference" format="dita" scope="local"> Dimensione</a> </p></td> 
  <td class="stentry"> <p>Decal/sovrapponi le dimensioni del livello. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Impostazioni avanzate di rendering. </p></td> 
 </tr> 
</table>

<table id="simpletable_BD278D96C3324004ABBBACEDF85F8D50"> 
 <thead class="sthead"> 
  <td class="stentry"> Mappe di vignetta</td> 
  <td class="stentry"> <p>Descrizione </p></td> 
 </thead> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Identificatore della vignetta (chiave di indice). </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Timestamp di modifica della vignetta. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-vignette-map-reference/r-ir-path-vignette.md#reference-aa1c007b63a04351b89881933deaf59c" type="reference" format="dita" scope="local"> Percorso</a> </p></td> 
  <td class="stentry"> <p>Percorso file vignetta. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-vignette-map-reference/r-ir-modifier.md#reference-cafa1623d65644be8cf3bda6a75ccbc4" type="reference" format="dita" scope="local"> Modificatore</a> </p></td> 
  <td class="stentry"> <p>Modificatori di richiesta predefiniti. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-vignette-map-reference/r-ir-userdata.md#reference-5bb5d49aee9c408992e41a5ad17d6e85" type="reference" format="dita" scope="local"> Dati utente</a> </p></td> 
  <td class="stentry"> <p>Dati definiti dall'utente. </p></td> 
 </tr> 
</table>
...
<table id="simpletable_B722319F81FB4DDA9AC16B27448B8F04"> 
 <thead class="sthead"> 
  <td class="stentry"> Definizioni delle macro</td> 
  <td class="stentry"> <p>Descrizione </p></td> 
 </thead> 
 <tr class="strow"> 
...
<table id="simpletable_54ED156EDA394412B5C4C49AA3A32828"> 
 <thead class="sthead"> 
  <td class="stentry"> Mappe del profilo ICC</td> 
  <td class="stentry"> <p>Descrizione </p></td> 
 </thead> 
 <tr class="strow"> 
