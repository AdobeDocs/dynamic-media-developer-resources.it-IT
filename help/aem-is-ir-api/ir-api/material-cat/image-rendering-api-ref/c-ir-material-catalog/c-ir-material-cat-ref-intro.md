---
description: Questo documento descrive il catalogo del materiale per il rendering immagini di Scene7.
seo-description: Questo documento descrive il catalogo del materiale per il rendering immagini di Scene7.
...
Questo documento descrive il catalogo del materiale per il rendering immagini di Scene7.

**Destinatari**

Questo documento è destinato a sviluppatori e programmatori di siti Web esperti che desiderano sfruttare il rendering delle immagini di Scene7 per un sito Web o un’applicazione personalizzata.

Si presume che il lettore abbia familiarità con Scene7 Image Authoring e Image Rendering, con gli standard e le convenzioni generali dei protocolli HTTP e con la terminologia di base dell’imaging.
...
<table id="simpletable_E96BA470B3CE4266A9E6ED0440A56C40"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> vignettatura:Item </span> </p> </td> 
