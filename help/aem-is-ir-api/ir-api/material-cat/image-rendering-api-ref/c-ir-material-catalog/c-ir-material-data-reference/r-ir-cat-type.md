---
description: Tipo di materiale. Tipo di superficie del materiale. Utilizzato in combinazione con la brillantezza del catalogo e la rugosità del catalogo per controllare gli effetti di rendering della riflessione 3D.
...
Tipo di materiale. Tipo di superficie del materiale. Utilizzato insieme a catalog::Gloss e catalog::Roughness per controllare gli effetti di rendering della riflessione 3D.

## Proprietà {#section-86e8bc194f764c848e0ee55630a5ac1b}

Enum. Facoltativo per tutti i materiali. Ignorato se la vignettatura non dispone di funzionalità di rendering riflesso 3D.

<table id="simpletable_85BF61871CAA420B92B855AAB8FACA2C"> 
 <tr class="strow"> 
  <td class="stentry"> <p>0 </p> </td> 
  <td class="stentry"> <p>Sconosciuto, il server utilizza quello predefinito. </p> </td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Tessuto puro. </p> </td> 
 </tr> 
 <tr class="strow"> 
