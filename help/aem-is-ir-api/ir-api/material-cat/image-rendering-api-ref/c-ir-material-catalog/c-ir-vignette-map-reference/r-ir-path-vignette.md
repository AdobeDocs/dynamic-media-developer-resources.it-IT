...
Il server combina questo valore con `attribute::RootPath` per generare il percorso effettivo del file di vignettatura. Può anche essere un percorso assoluto.
