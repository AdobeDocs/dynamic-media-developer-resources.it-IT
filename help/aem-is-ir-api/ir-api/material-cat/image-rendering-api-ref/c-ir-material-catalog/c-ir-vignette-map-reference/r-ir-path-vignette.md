---
description: Percorso file vignettatura. Percorso relativo e nome di un file di vignettatura.
...
Percorso file vignettatura. Percorso relativo e nome di un file di vignettatura.
...
Stringa di testo. Facoltativo. Se specificato, deve essere un percorso di file relativo o assoluto valido. Se vuoto, `vignette::Modifier` deve includere `vignette=` comando.
