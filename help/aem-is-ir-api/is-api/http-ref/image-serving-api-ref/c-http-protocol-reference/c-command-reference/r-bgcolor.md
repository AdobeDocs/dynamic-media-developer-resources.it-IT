...
Le aree trasparenti e semi-opache all’interno del rettangolo di selezione del livello vengono riempite con il colore specificato* dopo* `opac=`, `rotate=`e `extend=` vengono applicate.
