---
description: Questi comandi vengono applicati ai livelli immagine, testo e colore a tinta unita. La maggior parte non è significativa per l’immagine composita e per richieste semplici non a più livelli. Non vengono applicate ai livelli dell'effetto.
solution: Experience Manager
title: Comandi per livelli comuni
...
# Comandi per livelli comuni{#common-layer-commands}

Questi comandi vengono applicati ai livelli immagine, testo e colore a tinta unita. La maggior parte non è significativa per l’immagine composita e per richieste semplici non a più livelli. Non vengono applicate ai livelli dell&#39;effetto.
...
<table id="simpletable_8A74E965537D4E8CB91E95AEAE9673E0"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> Estensione <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-extend.md#reference-7e9156beb285459d830e2d56782a74ac" type="reference" format="dita" scope="local"></a> </p></td> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-layer.md#reference-0f8d7fbef64841dd855917bd8fc22e6d" type="reference" format="dita" scope="local"> livello</a> </p></td> 
  <td class="stentry"> <p>Seleziona il livello e specifica l'ordine z. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> Mappa <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-map.md#reference-8f96545f196b4b7caa616e15c2363f06" type="reference" format="dita" scope="local"></a> </p></td> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> Dimensione <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-size-reference.md#reference-04d383f32c7b4003bed9978cb854747b" type="reference" format="dita" scope="local"></a> </p></td> 
  <td class="stentry"> <p>Specifica il vincolo di dimensione del livello. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-hide.md#reference-e336facb21a644eea78c2c84c1c4576e" type="reference" format="dita" scope="local"> nascondi</a> </p></td> 
  <td class="stentry"> <p>Nascondete il livello. </p></td> 
 </tr> 
</table>
