---
description: Questi comandi possono essere utilizzati per definire effetti livello, ad esempio effetti ombra esterna o bagliore. I livelli degli effetti ignorano tutti gli altri comandi.
seo-description: Questi comandi possono essere utilizzati per definire effetti livello, ad esempio effetti ombra esterna o bagliore. I livelli degli effetti ignorano tutti gli altri comandi.
seo-title: Comandi degli effetti livello
solution: Experience Manager
title: Comandi degli effetti livello
...
# Comandi degli effetti livello{#layer-effect-commands}

Questi comandi possono essere utilizzati per definire effetti livello, ad esempio effetti ombra esterna o bagliore. I livelli degli effetti ignorano tutti gli altri comandi.
...
<table id="simpletable_3094B9783772437FAACF9B382F7A32EE"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Specifica come utilizzare la maschera di livello del livello principale (canale alfa). </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-op-grow.md#reference-f95f3291c78c42b9a34b1b7e177e739a" type="reference" format="dita" scope="local"> op_develop</a> </p></td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Aggiunge disturbo all’effetto. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Posiziona il livello dell’effetto rispetto al livello principale. </p></td> 
 </tr> 
</table>
