 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>Image Server riconosce inoltre i seguenti comandi di sottolineatura RTF: </p> <p> 
     ...
     </ul> </p> <p>Questi vengono implementati in questo momento come standard <span class="codeph"> \ul </span> sottolineatura. Tutti gli altri comandi di sottolineatura RTF vengono ignorati. </p> </td> 
  </tr> 
  <tr> 
