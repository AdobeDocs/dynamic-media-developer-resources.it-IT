...
Gli esempi seguenti mostrano un esempio di comandi di testo e di come influiscono sul testo.

`http://server?fmt=png&size=300,50&bgc=f0f0f0&text=\fs16eight,%20\fs32sixteen,%20\fs60thirty,%20\fs100fifty`

![Esempio di codifica RTF per un’immagine](assets/rtf01.png)
...
![Esempio di codifica RTF quattro immagini](assets/rtf04.png)
...
![Esempio di codifica RTF otto immagine](assets/rtf08.png)
