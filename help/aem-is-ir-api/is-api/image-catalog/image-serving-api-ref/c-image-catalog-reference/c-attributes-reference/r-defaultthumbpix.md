...
Il server vincola le immagini di risposta ad avere una larghezza e un&#39;altezza non superiori a quelle indicate, se una richiesta di miniatura ( `req=tmb`) non specifica esplicitamente la dimensione della visualizzazione utilizzando `wid=`, `hei=`o `scl=`.
