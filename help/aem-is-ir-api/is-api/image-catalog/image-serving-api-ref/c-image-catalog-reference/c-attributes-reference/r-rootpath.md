...
Il valore `RootPath` è una stringa di testo. Consulta [Gestione dei dati](../../../../../is-api/image-serving-api-ref/c-configuration-and-administration/c-managing-content/r-source-data.md#reference-4eebd51b2db2401c90be771d3382329e) di origine per ulteriori informazioni sui percorsi radice del server.
