...
Stringa di testo. Se specificato, deve essere un `Catalog::Id` valore valido in questo catalogo immagini (o nel catalogo predefinito, se specificato in [!DNL default.ini]).

## Predefinito {#section-f8a2029b5b8740b2af149bdbfa28fbae}

Ereditato da `default::Watermark` se non definito. Se definito ma vuoto, non viene applicata alcuna filigrana al catalogo immagini, anche se `default::Watermark` è definito.
