---
description: I file di attributi del catalogo riconoscono questi attributi di gestione del catalogo.
seo-description: I file di attributi del catalogo riconoscono questi attributi di gestione del catalogo.
seo-title: Gestione catalogo
...
# Gestione catalogo{#catalog-management}

I file di attributi del catalogo riconoscono questi attributi di gestione del catalogo.

<table id="simpletable_010A9494BFEB45F0A46FE9709E0404CA"> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-catalogfile.md#reference-16498bb4cb33458697c1ab002ea8db79" type="reference" format="dita" scope="local"> FileCatalogo</a> </span> </p></td> 
  <td class="stentry"> <p>Nomi dei file di dati immagine associati. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-svgcatalogfile.md#reference-cd61769073f145e1ac37aa4fd53ae58d" type="reference" format="dita" scope="local"> FileCatalogoSvg</a> </span> </p></td> 
  <td class="stentry"> <p>Nomi dei file di dati SVG associati. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-staticcontentcatalogfile.md#reference-1d5505d9d1b74fe5ba63fbdf7893eb0d" type="reference" format="dita" scope="local"> FileCatalogoStatico</a> </span> </p></td> 
  <td class="stentry"> <p>Nomi dei file di dati del contenuto statico associati. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Nome del file di mappa dei font associato. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Nome del file associato che definisce le regole URL pre-processore. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Opzione di corrispondenza del catalogo. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Abilitare gli stili sintetici in grassetto/corsivo. </p></td> 
 </tr> 
</table>
