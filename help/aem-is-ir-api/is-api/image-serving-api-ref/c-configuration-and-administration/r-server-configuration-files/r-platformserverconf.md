...
È possibile modificare solo le impostazioni elencate di seguito in [!DNL PlatformServer.conf]. Se una particolare impostazione è assente, può essere aggiunta in qualsiasi punto del file. Può essere presente una sola istanza di ciascuna impostazione.
...
<table id="simpletable_38244750F50A46E5B0077F5F860B125C"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p>Configurazione di SVG </p> </td> 
