...
Il formato url per il proxy IS è molto simile alle richieste IS regolari. Eventuali modificatori IS passati al proxy vengono passati al server immagini. Potete trovare informazioni sui modificatori IS nella Guida di riferimento [del protocollo](../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-introduction/c-introduction.md#concept-dbbd5241bc6248ad9b9d7f6c635c311e)HTTP.
...
<table id="simpletable_40C1DFB183B54A79BCF65D51ED480CE0"> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> widget = &lt;numero&gt;</span> </p></td> 
