...
<table id="table_02011C7C076745A8BF4378B22C48C8A3"> 
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> -usm &lt; <span class="varname"> quantità </span>&gt; &lt; <span class="varname"> raggio </span>&gt; &lt; <span class="varname"> soglia </span>&gt; &lt; <span class="varname"> monocromatico </span>&gt; </span> </p> </td> 
   <td colname="col2"> <p>Applicate la maschera di contrasto ai livelli piramidali sottocampionati. Consulta <a href="../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-op-usm.md#reference-51ac75adadfe4346ab60953192d0a1aa" type="reference" format="dita" scope="local"> op_usm= </a> per i dettagli. (non applicata all'immagine a risoluzione completa). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> -autocrop &lt; <span class="varname"> angolo </span>&gt; &lt; <span class="varname"> modalità </span>&gt; &lt; <span class="varname"> tolleranza </span>&gt; &lt; <span class="varname"> infoFile </span>&gt; </span> </p> </td> 
...
<p>  
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Imponi la decodifica e la nuova codifica delle immagini di input JPEG. </p> <p> <b>Attenzione:</b> L'applicazione di questa opzione può ridurre la qualità dell'immagine. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Consenti la sovrascrittura di un elemento esistente <span class="codeph"> <span class="varname"> destFile </span> </span>. Per impostazione predefinita, al nome del file viene aggiunto un suffisso numerico per impedire la sovrascrittura. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> -maxmempercent &lt; <span class="varname"> percentuale </span>&gt; </span> </p> </td> 
   <td colname="col2"> <p>Limite di utilizzo della memoria. Il valore predefinito corrisponde al 25% della memoria fisica. Se nessuno dei due <span class="codeph"> maxmem </span> né <span class="codeph"> maxmempercent </span> vengono impostate in modo esplicito per utilizzare l'impostazione predefinita maxmempercent. </p> </td> 
  </tr> 
  <tr> 
...
Converti tutte le immagini in *`srcFolder`* ai TIFF piramidali con codifica JPEG e posiziona in *`destFolder`*:
