...
Il pulsante è visibile solo se il parametro `CarouselViewer.autoplay` è impostato su `1`. In caso contrario, è nascosto. È possibile ridimensionare, applicare lo skin e posizionare questo pulsante rispetto alla barra di controllo che lo contiene utilizzando gli stili CSS.
