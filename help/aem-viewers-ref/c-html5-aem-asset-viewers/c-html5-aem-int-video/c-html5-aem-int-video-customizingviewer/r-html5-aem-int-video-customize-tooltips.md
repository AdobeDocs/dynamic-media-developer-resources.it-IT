...
>[!NOTE]
>
>Se gli stili di descrizione comandi vengono personalizzati dalla pagina Web in cui è incorporato, tutte le proprietà devono contenere la regola `!IMPORTANT`. Questa nota non è necessaria se le descrizioni comandi sono personalizzate all&#39;interno del file CSS del visualizzatore.
