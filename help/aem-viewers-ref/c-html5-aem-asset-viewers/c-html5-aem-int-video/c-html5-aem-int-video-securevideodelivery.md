...
* Se pubblichi un video [!DNL Dynamic Media] con un URL, aggiungi `VideoPlayer.ssl` all&#39;URL. Ad esempio, per forzare la consegna sicura dei video, aggiungi `&VideoPlayer.ssl=on` alla fine del seguente esempio di URL visualizzatore:
