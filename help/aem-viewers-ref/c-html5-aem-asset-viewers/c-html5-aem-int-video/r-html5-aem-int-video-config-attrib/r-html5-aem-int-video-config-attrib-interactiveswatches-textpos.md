...
<table id="table_441553CD34C94A58A9D7CBF772DEDDB6"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Specifica dove viene disegnata l'etichetta rispetto all'immagine campione. In altre parole, l’etichetta viene centrata nella posizione specificata relativa alla miniatura. </p> <p>Quando <span class="codeph"> descrizione comando</span> Se è specificata, il testo dell'etichetta viene visualizzato come descrizione mobile sopra l'immagine di miniatura. </p> <p>Imposta su <span class="codeph"> nessuno</span> per spegnere l'etichetta. </p> </td> 
  </tr> 
 </tbody> 
</table>
