...
description: Tutte le personalizzazioni visive e la maggior parte delle personalizzazioni dei comportamenti per il Visualizzatore video360 vengono eseguite creando un CSS personalizzato.
keywords: responsive
...
Tutte le personalizzazioni visive e la maggior parte delle personalizzazioni dei comportamenti per il Visualizzatore video360 vengono eseguite creando un CSS personalizzato.
...
Quando crei CSS personalizzato, tieni presente che il visualizzatore assegna la classe `.s7video360viewer` all&#39;elemento DOM contenitore. Se si utilizza un file CSS esterno passato con il comando `style=`, utilizzare la classe `.s7video360viewer` come classe padre nel selettore discendente per le regole CSS. Se esegui stili incorporati nella pagina web, qualifica anche questo selettore con un ID dell’elemento DOM del contenitore come segue:
...
Il visualizzatore supporta due meccanismi di creazione di CSS dinamici: marcatori CSS e query multimediali CSS standard. È possibile utilizzare marcatori o query in modo indipendente o insieme.

**Indicatori CSS**

Per facilitare la creazione di CSS dinamici, il visualizzatore supporta i marcatori CSS. Questi marcatori sono classi CSS speciali assegnate dinamicamente all’elemento contenitore del visualizzatore di primo livello. Si basano sulle dimensioni del visualizzatore in fase di esecuzione e sul tipo di input utilizzato sul dispositivo corrente.
...
Di seguito è riportata la documentazione di riferimento sugli elementi dell&#39;interfaccia utente applicabile a Video360 Viewer:
