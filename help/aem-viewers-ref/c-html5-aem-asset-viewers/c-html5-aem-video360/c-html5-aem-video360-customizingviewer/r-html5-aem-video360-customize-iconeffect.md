...
L&#39;effetto icona supporta il selettore di attributi `state`. Il selettore di attributi `state="play"` viene utilizzato quando il video viene messo in pausa durante la riproduzione e `state="replay"` quando l&#39;indicatore di riproduzione si trova alla fine del flusso.
