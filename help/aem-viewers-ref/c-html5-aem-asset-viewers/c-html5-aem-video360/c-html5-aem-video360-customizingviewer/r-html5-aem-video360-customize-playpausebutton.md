...
>[!NOTE]
>
>Questo pulsante supporta sia i selettori `state``selected`che `replay` di attributi, che possono essere utilizzati per applicare interfacce diverse a stati di pulsante differenti. In particolare, `selected='true'` corrisponde allo stato &quot;play&quot; e `selected='false'` allo stato &quot;pause&quot;;
>
...
**Esempio** - Per impostare un pulsante di riproduzione/pausa di 32 x 32 pixel; è posizionato a sei pixel dal bordo superiore e sinistro della barra di controllo e, se selezionato o meno, visualizza un’immagine diversa per ciascuno dei quattro stati del pulsante.
