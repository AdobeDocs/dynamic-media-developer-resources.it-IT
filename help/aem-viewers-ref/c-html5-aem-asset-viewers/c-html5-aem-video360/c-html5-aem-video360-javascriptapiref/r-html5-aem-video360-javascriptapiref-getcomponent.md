...
Quando si lavora con le API SDK, è importante utilizzare uno spazio dei nomi SDK completo corretto come descritto in [Spazio dei nomi SDK per visualizzatori](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621).

Consulta la *API SDK di HTML5 Viewer* per ulteriori informazioni su un particolare componente.

## Restituisce {#section-1d3cf85bc7cc4dfe9670e038d02b9101}

Il `{Object}` è un riferimento al componente SDK del visualizzatore. Il metodo restituisce `null` se `componentId` non è un componente visualizzatore supportato o se il componente non è ancora stato creato dalla logica del visualizzatore.
