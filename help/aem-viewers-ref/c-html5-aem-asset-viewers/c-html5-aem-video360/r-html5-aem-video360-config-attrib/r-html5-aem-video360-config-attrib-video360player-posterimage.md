 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Modificatori Image Serving che controllano l'aspetto dell'immagine poster. Se specificato nell’URL, codifica HTTP come segue: </p> <p> 
     ...
     </ul> </p> <p> Questo modificatore funziona per il contenuto video in hosting su Dynamic Media Classic o Adobe Experience Manager, Dynamic Media. </p> <p>Per impedire la visualizzazione dell'immagine poster predefinita, specifica <span class="codeph"> none</span> come valore dell'immagine poster. </p> </td> 
  </tr> 
 </tbody> 
</table>
