...
1. Impostazione delle dimensioni del visualizzatore
   ...
   Inserisci le dimensioni nel CSS direttamente nella pagina HTML o in un file CSS visualizzatore personalizzato. Viene quindi assegnato in seguito a un record del predefinito visualizzatore in Dynamic Media Classic o passato esplicitamente utilizzando un comando di stile.
