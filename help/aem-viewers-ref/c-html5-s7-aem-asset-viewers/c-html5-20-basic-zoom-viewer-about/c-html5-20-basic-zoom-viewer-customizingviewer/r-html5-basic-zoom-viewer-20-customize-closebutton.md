...
description: Selezionando questo pulsante si chiude la pagina Web che la contiene. Questo pulsante viene visualizzato solo se il parametro closebutton è impostato su 1. Puoi ridimensionare, applicare lo skin e posizionare questo pulsante utilizzando gli stili CSS.
...
Toccando o facendo clic su questo pulsante si chiude la pagina Web che la contiene. Questo pulsante viene visualizzato solo se il parametro closebutton è impostato su 1. Puoi ridimensionare, applicare lo skin e posizionare questo pulsante utilizzando gli stili CSS.
...
Esempio: per impostare un pulsante Chiudi di 32 x 32 pixel e posizionare sei pixel dal bordo superiore e destro del visualizzatore. Deve visualizzare un&#39;immagine diversa per ciascuno dei quattro diversi stati dei pulsanti.
