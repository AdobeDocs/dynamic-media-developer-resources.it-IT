...
Ad esempio, se intendete ascoltare l&#39; `StatusEvent.NOTF_VIEW_READY` evento e il visualizzatore viene servito da AEM, il tipo di evento completo è `s7viewers.s7sdk.event.StatusEvent.NOTF_VIEW_READY`e il codice del listener di eventi è simile al seguente:
