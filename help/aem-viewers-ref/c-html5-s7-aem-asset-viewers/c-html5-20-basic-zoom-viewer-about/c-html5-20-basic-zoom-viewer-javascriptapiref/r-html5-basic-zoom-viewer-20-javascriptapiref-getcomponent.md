...
Quando si lavora con le API SDK, è importante utilizzare uno spazio dei nomi SDK corretto e completo, come descritto in Spazio dei nomi SDK per visualizzatore
