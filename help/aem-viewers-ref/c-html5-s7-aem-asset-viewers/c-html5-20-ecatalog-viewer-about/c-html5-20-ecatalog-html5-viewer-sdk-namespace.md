...
Ad esempio, se prevedete di ascoltare l’ `StatusEvent.NOTF_VIEW_READY` evento e il visualizzatore viene servito da SPS, il tipo di evento completo è `s7classic.s7sdk.event.StatusEvent.NOTF_VIEW_READY`e il codice del listener di eventi è simile al seguente:
