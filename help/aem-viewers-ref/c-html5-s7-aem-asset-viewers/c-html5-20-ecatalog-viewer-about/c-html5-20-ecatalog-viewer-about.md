...
Questo visualizzatore è completamente accessibile tramite tastiera come descritto in Accessibilità e navigazione [da](../../c-keyboard-accessibility.md#topic-f5650e9493404e55a3627c8d1366b861)tastiera.
...
## Incorporazione del visualizzatore per eCatalog {#section-6bb5d3c502544ad18a58eafe12a13435}
...
Si consiglia di utilizzare una pagina HTML out-of-the-box per la modalità operativa a comparsa. In questo caso, viene chiamato [!DNL eCatalogViewer.html] e si trova nella [!DNL html5/] sottocartella della distribuzione standard dei visualizzatori IS:
...
1. Impostazione delle dimensioni del visualizzatore
   ...
   Potete impostare le dimensioni statiche per il visualizzatore dichiarandolo per la classe CSS di livello `.s7ecatalogviewer` principale in unità assolute oppure utilizzando il `stagesize` modificatore.
...
1. Inizializzazione del visualizzatore.
   ...
   Di seguito è riportato un esempio di creazione di un&#39;istanza di visualizzatore, passaggio delle opzioni di configurazione minime necessarie al costruttore e chiamata del `init()` metodo. L’esempio presuppone che `eCatalogViewer` sia l’istanza del visualizzatore; `s7viewer` è il nome del segnaposto `DIV`; è `http://s7d1.scene7.com/is/image/` l’URL del server immagini ed `Viewers/Pluralist` è la risorsa:
   ...
   Il codice seguente è un esempio completo di una pagina Web semplice che incorpora il visualizzatore di eCatalog con una dimensione fissa:
