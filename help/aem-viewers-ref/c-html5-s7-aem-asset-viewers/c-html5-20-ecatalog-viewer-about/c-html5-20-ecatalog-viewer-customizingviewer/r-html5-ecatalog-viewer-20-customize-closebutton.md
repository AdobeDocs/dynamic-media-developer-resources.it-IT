---
description: Toccando o facendo clic su questo pulsante si chiude la pagina Web contenitore. Questo pulsante viene visualizzato solo se il parametro close button è impostato su 1. Questo pulsante non è disponibile sui sistemi desktop. Questo pulsante può essere ridimensionato, incarnato e posizionato mediante CSS.
seo-description: Toccando o facendo clic su questo pulsante si chiude la pagina Web contenitore. Questo pulsante viene visualizzato solo se il parametro close button è impostato su 1. Questo pulsante non è disponibile sui sistemi desktop. Questo pulsante può essere ridimensionato, incarnato e posizionato mediante CSS.
...
Toccando o facendo clic su questo pulsante si chiude la pagina Web contenitore. Questo pulsante viene visualizzato solo se il parametro close button è impostato su 1. Questo pulsante non è disponibile sui sistemi desktop. Questo pulsante può essere ridimensionato, incarnato e posizionato mediante CSS.
...
Esempio: per impostare un pulsante di chiusura di 56 x 56 pixel, posizionato 4 pixel dal bordo superiore e destro della barra di controllo principale, e visualizza un’immagine diversa per ciascuno dei quattro stati del pulsante.
