...
Esempio: per impostare un pulsante a schermo intero di 28 x 28 pixel, posizionato 4 pixel dal basso e 5 pixel dal bordo destro della barra di controllo principale, e visualizza un’immagine diversa per ciascuno dei quattro stati del pulsante, se selezionato o non selezionato.
