...
seo-title: Pulsante Pagina successiva grande
...
# Pulsante grande pagina successiva{#large-next-page-button}
...
Esempio: per impostare un grande pulsante per la pagina successiva da 56 x 56 pixel, centrato verticalmente e ancorato al bordo destro del visualizzatore, e visualizza un’immagine diversa per ciascuno dei quattro stati del pulsante.
