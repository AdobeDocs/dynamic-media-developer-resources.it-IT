...
Quando si seleziona o si tocca questo pulsante, il visualizzatore viene reimpostato tra la visualizzazione principale e le miniature. Questo pulsante viene visualizzato nella barra di controllo principale. Puoi ridimensionare, skin e posizionare questo pulsante utilizzando CSS.
...
Esempio: per impostare il pulsante miniature che è 28 x 28 pixel e si trova a 4 pixel dal fondo e a 5 pixel dal bordo sinistro della barra di controllo principale. Infine, visualizza un’immagine diversa per ciascuno dei quattro stati dei pulsanti selezionati o meno.
