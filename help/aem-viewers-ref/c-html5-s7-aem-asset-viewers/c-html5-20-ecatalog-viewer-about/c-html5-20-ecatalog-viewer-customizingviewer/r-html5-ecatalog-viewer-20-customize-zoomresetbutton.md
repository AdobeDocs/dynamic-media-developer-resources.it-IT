...
Se si seleziona o si tocca questo pulsante, viene ripristinata un&#39;immagine nella visualizzazione principale. Questo pulsante viene visualizzato nella barra di controllo principale dei sistemi desktop e tablet. Sui telefoni cellulari, questo pulsante viene visualizzato in basso al centro sull’immagine. Tuttavia, non viene visualizzato quando l’immagine è in stato di ripristino. Puoi ridimensionare, applicare lo skin e posizionare questo pulsante utilizzando gli stili CSS.
...
Esempio: per impostare un pulsante di ripristino dello zoom di 28 x 28 pixel posizionato (sul desktop) a 4 pixel dal basso e a 47 pixel dal bordo destro della barra di controllo principale. Infine, visualizza un&#39;immagine diversa per ciascuno dei quattro diversi stati dei pulsanti.
