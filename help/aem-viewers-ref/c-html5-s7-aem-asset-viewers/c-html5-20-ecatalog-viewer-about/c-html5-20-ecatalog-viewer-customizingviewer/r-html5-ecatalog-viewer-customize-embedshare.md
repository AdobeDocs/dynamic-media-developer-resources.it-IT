...
Esempio: per impostare una sovrapposizione di sfondo grigia con opacità 70%:
...
Esempio: per impostare l&#39;intestazione della finestra di dialogo con spaziatura interna, l&#39;icona 24 x 14 pixel e il titolo in grassetto a 16 punti. E un pulsante Chiudi di 28 x 28 pixel, posizionato due pixel dalla parte superiore e due pixel dalla destra del contenitore della finestra di dialogo:
...
Esempio - Per impostare un piè di pagina della finestra di dialogo con un pulsante Annulla 64 x 34, un pulsante Seleziona tutto 82 x 34 e con un colore di testo e uno sfondo diversi per ogni stato del pulsante:
...
Esempio: per impostare un&#39;area della finestra di dialogo principale di 300 pixel, impostare un margine di dieci pixel e utilizzare uno sfondo bianco:
...
L’etichetta della dimensione di incorporamento e il menu a discesa sono posizionati nella parte inferiore della finestra di dialogo e inseriti in un contenitore controllato con il seguente selettore di classe CSS:
...
Esempio: per impostare un miniatore della barra di scorrimento di 28 x 45 pixel, con un margine di dieci pixel in alto e in basso e un disegno diverso per ciascuno stato:
...
Le descrizioni dei pulsanti possono essere localizzate. Consulta [Localizzazione degli elementi dell’interfaccia utente](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) per ulteriori informazioni.
