...
Esempio: per impostare l’intestazione della finestra di dialogo con spaziatura, icona 24 x 14 pixel e titolo in grassetto a 16 punti. E un pulsante Chiudi 28 x 28 pixel, posizionato due pixel dalla parte superiore e due pixel dalla parte destra del contenitore di dialogo:
...
Esempio: per impostare un bordo grigio di un pixel intorno al testo del codice da incorporare, impostarlo con una larghezza di 430 pixel e una spaziatura di dieci pixel:
...
L’etichetta e l’elenco a discesa delle dimensioni di incorporamento vengono posizionati nella parte inferiore della finestra di dialogo e inseriti in un contenitore controllato con il seguente selettore di classe CSS:
...
Esempio: per impostare la dimensione personalizzata del pannello dei campi di input a 20 pixel a destra della casella combinata:
...
Le descrizioni dei pulsanti possono essere localizzate. Vedi [Localizzazione degli elementi dell’interfaccia utente](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) per ulteriori informazioni.
