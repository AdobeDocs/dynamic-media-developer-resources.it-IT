...
Ad esempio, se intendete ascoltare `StatusEvent.NOTF_VIEW_READY` l’evento e il visualizzatore viene distribuito da Scene7 Publishing System, il tipo di evento completo è `s7classic.s7sdk.event.StatusEvent.NOTF_VIEW_READY`e il codice del listener di eventi è simile al seguente:
