...
seo-description: Lo strumento Stampa è costituito da un pulsante aggiunto alla barra di controllo e dalla finestra di dialogo modale visualizzata quando lo strumento è attivato.
seo-title: Stampa
...
Esempio: per impostare un pulsante di stampa di 28 x 28 pixel e visualizzare un&#39;immagine diversa per ciascuno dei quattro stati del pulsante.
...
Per impostazione predefinita, la finestra di dialogo modale viene visualizzata centrata sullo schermo sui sistemi desktop. Il posizionamento e il ridimensionamento della finestra di dialogo sono gestiti dal componente La finestra di dialogo è controllata dal seguente selettore di classe CSS:
...
L’icona e il testo del titolo sono racchiusi in un contenitore aggiuntivo controllato dai seguenti elementi:
...
È possibile localizzare la descrizione del pulsante Chiudi e il titolo della finestra di dialogo. Per ulteriori informazioni, consultate [Localizzazione degli elementi](../../../c-html5-s7-aem-asset-viewers/c-html5-ecatsearch-viewer-about/c-html5-ecatsearch-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) dell&#39;interfaccia utente.

Esempio: per impostare l’intestazione della finestra di dialogo con la spaziatura, l’icona da 22x22 pixel, il titolo in grassetto da 16 punti e un pulsante Chiudi da 28x28 pixel posizionato due pixel dalla parte superiore e due pixel dal lato destro del contenitore della finestra di dialogo:
...
Le descrizioni dei pulsanti possono essere localizzate. Per ulteriori informazioni, consultate [Localizzazione degli elementi](../../../c-html5-s7-aem-asset-viewers/c-html5-ecatsearch-viewer-about/c-html5-ecatsearch-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) dell&#39;interfaccia utente.

Esempio: per impostare un piè di pagina di una finestra di dialogo con il pulsante Annulla 64x34 e il pulsante Invia a stampa 96x34, con il colore del testo e dello sfondo diversi per ogni stato del pulsante:
...
Esempio: per impostare un&#39;area di dialogo principale in modo che venga calcolata automaticamente l&#39;altezza, avere un margine di dieci pixel e utilizzare uno sfondo bianco:
...
La dimensione del blocco di contenuto finestra di dialogo è controllata dal seguente selettore di classe CSS:
...
Esempio: per impostare un blocco di contenuto su una larghezza di 430 pixel e disporre di una spaziatura di 10 pixel nella parte inferiore:
...
I controlli di input sono racchiusi nel contenitore e controllati con il seguente selettore di classe CSS:
...
I selettori numerici per la selezione dell&#39;intervallo di stampa sono controllati dal seguente selettore di classe CSS
...
Esempio: per impostare tutti i pulsanti di scelta su una larghezza di 150 pixel con testo nero, una spaziatura di 10 pixel e un selettore numerico di 42 pixel:
...
Il separatore orizzontale tra la selezione dell&#39;intervallo di pagine e le sezioni del layout di stampa è controllato dal seguente selettore di classe CSS:
...
Esempio: per impostare un divisore grigio largo 430 pixel con una spaziatura verticale di 10 pixel su entrambi i lati e un margine di 10 pixel sulla parte superiore:
