...
L’aspetto del pulsante Download è controllato con il seguente selettore di classe CSS:

```
.s7ecatalogsearchviewer .s7download
```

**Proprietà CSS del pulsante Download**
...
Esempio : per impostare un pulsante Download di 28 x 28 pixel e visualizzare un’immagine diversa per ciascuno dei quattro stati del pulsante:
