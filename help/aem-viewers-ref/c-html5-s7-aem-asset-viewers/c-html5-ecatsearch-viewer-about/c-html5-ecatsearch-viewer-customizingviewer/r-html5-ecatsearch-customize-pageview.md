...
È possibile configurare la visualizzazione dei cursori del mouse personalizzati sull&#39;area del visualizzatore principale. Questa funzionalità è controllata con i selettori di attributi aggiuntivi applicati a `.s7ecatalogsearchviewer .s7pageview` Classe CSS:
