...
È possibile configurare la visualizzazione dei cursori personalizzati del mouse sull&#39;area del visualizzatore principale. Questa funzionalità è controllata con selettori di attributi aggiuntivi applicati a `.s7ecatalogsearchviewer .s7pageview` Classe CSS:
