...
È possibile configurare la visualizzazione dei cursori personalizzati del mouse sull&#39;area del visualizzatore principale. Questa capacità è controllata con selettori di attributi aggiuntivi applicati alla classe CSS `.s7ecatalogsearchviewer .s7pageview`:
