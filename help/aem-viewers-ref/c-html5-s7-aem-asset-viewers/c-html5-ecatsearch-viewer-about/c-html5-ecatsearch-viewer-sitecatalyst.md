---
description: Il visualizzatore di ricerca per eCatalog supporta  tracciamento Adobe Analytics.
seo-description: Il visualizzatore di ricerca per eCatalog supporta  tracciamento Adobe Analytics.
...
Il visualizzatore di ricerca per eCatalog supporta  tracciamento Adobe Analytics.

## Tracciamento out-of-the-box {#section-ba994f079d0343c8ae48adffaa3195a3}

Il visualizzatore di ricerca per eCatalog supporta il tracciamento out-of-the-box. [!DNL Adobe Analytics] Per abilitare il tracciamento, passate il nome corretto del predefinito della società come parametro `config2`.
