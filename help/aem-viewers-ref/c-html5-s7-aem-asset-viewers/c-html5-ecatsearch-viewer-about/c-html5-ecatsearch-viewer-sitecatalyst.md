...
seo-description: Il visualizzatore di ricerca per eCatalog supporta il tracciamento di Adobe Analytics.
...
Il visualizzatore di ricerca per eCatalog supporta il [!DNL Adobe Analytics] tracciamento out-of-the-box. Per abilitare il tracciamento, passate il nome corretto del predefinito della società come `config2` parametro.
