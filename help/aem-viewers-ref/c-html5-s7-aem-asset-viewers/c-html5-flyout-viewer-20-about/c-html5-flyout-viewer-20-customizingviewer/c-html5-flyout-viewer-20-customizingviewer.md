...
seo-title: Personalizzazione del visualizzatore a comparsa
...
Con un approccio classico allo stile, il CSS avrebbe un riferimento separato al singolo file di immagine sul server per ogni stato dell&#39;elemento dell&#39;interfaccia utente. Esempio di CSS per lo stile del pulsante di scorrimento:
...
* [Evidenziazione dello stato](r-html5-flyout-viewer-20-customize-focushighlight.md)
