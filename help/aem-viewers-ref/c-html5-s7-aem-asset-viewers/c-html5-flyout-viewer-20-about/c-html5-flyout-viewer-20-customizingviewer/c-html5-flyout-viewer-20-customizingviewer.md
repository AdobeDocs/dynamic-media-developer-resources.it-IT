...
description: Personalizzazione del visualizzatore a comparsa
keywords: responsive
...
L’utilizzo dei marcatori CSS è il modo più flessibile per creare CSS progettati responsive. Il motivo è che ti consente di impostare come destinazione non solo le dimensioni dello schermo del dispositivo, ma anche quelle effettive del visualizzatore, il che può essere utile per i layout reattivi progettati per le pagine web.
...
## Spunti CSS {#section-0711ece44a4740168cfd7624c9010bd1}
...
Con un approccio classico allo stile, il CSS avrebbe un riferimento separato a un singolo file di immagine sul server per ogni stato dell’elemento dell’interfaccia utente. Di seguito è riportato un esempio di CSS per il pulsante di scorrimento degli stili:
...
* [Visualizzazione zoom a comparsa](r-html5-flyout-viewer-20-customize-flyoutzoomview.md)
* [Evidenziazione focus](r-html5-flyout-viewer-20-customize-focushighlight.md)
* [Area visualizzatore principale](r-html5-flyout-viewer-20-customize-mainviewerarea.md)
* [Campioni](r-html5-flyout-viewer-20-customize-swatches.md)
* [Descrizione](r-html5-flyout-viewer-20-customize-tooltips.md)
