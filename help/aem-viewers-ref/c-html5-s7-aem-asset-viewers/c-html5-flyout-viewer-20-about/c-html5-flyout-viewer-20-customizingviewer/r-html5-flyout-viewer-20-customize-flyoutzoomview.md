...
<table id="table_F957367566C542829E2F6D296F9DAAC5"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Evidenzia opacità. </p> <p>Per Internet Explorer 8, utilizzate <span class="codeph"> filter:alpha(opacity-...) ); </span> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> border </span> </p> </td> 
...
Quando `highlightmode` il parametro è impostato su `cursor`, l&#39;evidenziazione si trova nella vista principale e viene sostituita da un&#39;immagine cursore a dimensione fissa, controllata dal selettore di classe CSS:
...
>[!NOTE]
>
>Il cursore supporta il selettore `input` di attributi, che può essere utilizzato per applicare grafica e dimensioni diverse del cursore per dispositivi diversi. In particolare, `input="mouse"` corrisponde ai sistemi desktop e `input="touch"` corrisponde ai dispositivi touch.

**Proprietà CSS della sovrapposizione**

Quando il `overlay` parametro è impostato su `1`, l&#39;area intorno al fotogramma di evidenziazione o l&#39;immagine del cursore viene controllata con il selettore di classe CSS:
...
Il messaggio di suggerimento può essere localizzato. Per ulteriori informazioni, consultate [Localizzazione degli elementi](../../../c-html5-s7-aem-asset-viewers/c-html5-flyout-viewer-20-about/c-html5-flyout-viewer-20-localization.md#concept-6c8e58c611934e93ae3f211f46e15c27) dell&#39;interfaccia utente.
