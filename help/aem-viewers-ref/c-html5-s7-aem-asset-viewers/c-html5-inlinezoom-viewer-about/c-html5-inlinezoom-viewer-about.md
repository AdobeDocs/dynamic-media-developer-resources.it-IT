...
Si consiglia di utilizzare la pagina HTML out-of-the-box per la modalità a comparsa denominata `FlyoutViewer.html`. che si trova nella [!DNL html5/] sottocartella della distribuzione standard di Image Serving Viewers:

`<s7viewers_root>/html5/FlyoutViewer.html`

È inoltre necessario che il componente FlyoutZoomView sia configurato per funzionare in modalità zoom in linea. Si consiglia di usare il predefinito `Scene7SharedAssets/Universal_HTML5_Zoom_Inline` out-of-the-box per il visualizzatore zoom in linea o un predefinito personalizzato da esso derivato. La personalizzazione visiva può essere ottenuta applicando CSS personalizzato.
...
1. Impostazione delle dimensioni del visualizzatore.
   ...
   Consultate [Personalizzazione del visualizzatore](../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-customizingviewer/c-html5-inlinezoom-viewer-customizingviewer.md#concept-82f8c71adbe54680a0c2f83f81e5f451) zoom in linea per ulteriori informazioni sullo stile del visualizzatore con i CSS.
...
* invece di impostare una dimensione fissa per il visualizzatore usando unità assolute, usate CSS che imposta il visualizzatore `width` e `height` il 100% come segue:
