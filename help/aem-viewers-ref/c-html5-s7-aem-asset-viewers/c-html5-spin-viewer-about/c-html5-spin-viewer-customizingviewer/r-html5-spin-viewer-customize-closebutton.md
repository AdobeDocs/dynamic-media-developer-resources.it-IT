...
description: Toccando o facendo clic su questo pulsante si chiude la pagina Web che la contiene. Questo pulsante viene visualizzato solo se il parametro closebutton è impostato su 1. Puoi ridimensionare, applicare lo skin e posizionare questo pulsante utilizzando gli stili CSS.
...
Selezionando questo pulsante si chiude la pagina Web che la contiene. Questo pulsante viene visualizzato solo se il parametro closebutton è impostato su 1. Puoi ridimensionare, applicare lo skin e posizionare questo pulsante utilizzando gli stili CSS.
...
La descrizione comando del pulsante può essere localizzata. Per ulteriori informazioni, vedere [Localizzazione degli elementi dell&#39;interfaccia utente](../../../c-html5-s7-aem-asset-viewers/c-html5-spin-viewer-about/c-html5-spin-viewer-localization.md#concept-e35c15c9e82648328806cdc6aa255d98).

Esempio: per impostare un pulsante Chiudi di 32 x 32 pixel e posizionare sei pixel dal bordo superiore e destro del visualizzatore. Infine, visualizza un&#39;immagine diversa per ciascuno dei quattro diversi stati dei pulsanti.
