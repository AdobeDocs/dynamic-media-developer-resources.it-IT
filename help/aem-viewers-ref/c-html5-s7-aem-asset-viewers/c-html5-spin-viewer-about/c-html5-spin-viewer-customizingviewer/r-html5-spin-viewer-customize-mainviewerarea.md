...
seo-description: L'area di visualizzazione principale è l'area occupata dall'immagine di rotazione. In genere viene impostato per adattarsi alla schermata del dispositivo disponibile quando non viene specificata alcuna dimensione.
