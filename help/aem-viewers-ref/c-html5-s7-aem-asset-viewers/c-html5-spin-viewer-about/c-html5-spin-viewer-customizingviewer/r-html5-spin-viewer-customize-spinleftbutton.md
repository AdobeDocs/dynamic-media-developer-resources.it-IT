...
seo-title: Pulsante Spin a sinistra
solution: Experience Manager
title: Pulsante Spin a sinistra
topic: Dynamic media
...
# Pulsante Spin a sinistra{#spin-left-button}
...
Esempio: per impostare un pulsante per la rotazione a sinistra di 28x28 pixel, posizionato sul bordo sinistro del contenitore interno, che visualizza un’immagine diversa per ciascuno dei quattro stati del pulsante:
