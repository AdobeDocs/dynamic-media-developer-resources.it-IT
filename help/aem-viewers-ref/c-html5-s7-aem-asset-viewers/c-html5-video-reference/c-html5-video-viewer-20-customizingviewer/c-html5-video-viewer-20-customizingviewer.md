...
seo-title: Personalizzazione del visualizzatore video
...
Quando create un CSS personalizzato, ricordate che il visualizzatore assegna la `.s7videoviewer` classe al relativo elemento DOM contenitore. Se utilizzate un file CSS esterno passato con il `style=` comando, utilizzate la `.s7videoviewer` classe come classe principale nel selettore discendente per le regole CSS. Se incorporate stili nella pagina Web, qualificate anche questo selettore con un ID dell’elemento DOM contenitore come segue:
...
## Note generali di stile e consigli {#section-097418bd618740bba36352629e4d88e1}
