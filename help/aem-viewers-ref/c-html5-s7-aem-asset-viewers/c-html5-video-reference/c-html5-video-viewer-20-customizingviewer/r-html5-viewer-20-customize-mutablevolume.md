...
Di seguito è riportato un esempio di come personalizzare il lettore video in modo che l&#39;audio venga disabilitato durante la riproduzione. Aggiungete il codice seguente al codice da incorporare del visualizzatore:
...
Nell’esempio di codice riportato sopra, il livello del volume è impostato `0` sul `mutableVolume` componente. Quindi, lo stesso componente viene disattivato e non può essere utilizzato dall’utente finale.
