...
Questa proprietà è obbligatoria, a meno che non venga utilizzato `video` il parametro. Consultate Supporto per video [esterni](../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-external-video-support.md#concept-22c67fee43274a29b28ee16770b1b1f3) in Supporto per video o video [esterni](../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-external-video-support.md#concept-66aa2784f2294794989bad2af74c3760) in Video360.
...
<table id="table_A2A0ACD942E942BC99AF0DC80FB1C670"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Specifica un set di immagini esplicito, costituito da una sequenza ordinata di elementi o fotogrammi, separati da virgole. </p> <p> <p>Nota:  Questa funzione è supportata in Adobe Scene7 Publishing System; non è supportato in Risorse Adobe Experience Manager. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> imageListWithModifiers <span class="varname"> </span></span> </p> </td> 
   <td colname="col2"> <p> Specifica un set di immagini esplicito in cui ogni fotogramma dispone di propri modificatori Image Server. In questo caso, l'elenco delle cornici è racchiuso tra parentesi. Assicuratevi di applicare la doppia codifica HTTP a qualsiasi virgola presente nel modificatore Image Server specifico per il fotogramma. </p> <p> <p>Nota:  Questa funzione è supportata in Adobe Scene7 Publishing System; non è supportato in Risorse Adobe Experience Manager. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> set <span class="varname"> 360 gradi multidimensionale </span></span> </p> </td> 
   <td colname="col2"> <p>Specifica un set 360 gradi multidimensionale esplicito con la sintassi seguente: </p> <p> <span class="codeph"> ( <span class="varname"> horizontalSpinSet </span>)[,( <span class="varname"> horizontalSpinSet </span>)] </span> </p> <p> dove <span class="codeph"> horizontal <span class="varname"> SpinSet </span> </span> è un elenco separato da virgole di fotogrammi per un dato asse orizzontale. Tutti i <span class="codeph"> set <span class="varname"> 360 gradi orizzontali </span> </span> devono avere lo stesso numero di fotogrammi. </p> <p> <p>Nota:  Questa funzione è supportata in Adobe Scene7 Publishing System; non è supportato in Risorse Adobe Experience Manager. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> modificatori </span></span> </p> </td> 
   <td colname="col2"> <p> Image Serving, comandi; <span class="codeph"> &amp; </span> e <span class="codeph"> = </span> i separatori devono essere codificati HTTP rispettivamente come <span class="codeph"> %26 </span> e <span class="codeph"> %3D </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D31C8507C02A4452A79DEDDEC62EF2F5"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Video singolo o set video adattivo. </p> <p> <p>Nota:  Questa funzione è supportata in Adobe Scene7 Publishing System; non è supportato in Risorse Adobe Experience Manager. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> immagine </span></span> </p> </td> 
   <td colname="col2"> <p> Immagine singola. </p> <p> <p>Nota:  Questa funzione è supportata in Adobe Scene7 Publishing System; non è supportato in Risorse Adobe Experience Manager. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> setId </span></span> </p> </td> 
   <td colname="col2"> <p> Set di campioni. </p> <p> <p>Nota:  Questa funzione è supportata in Adobe Scene7 Publishing System; non è supportato in Risorse Adobe Experience Manager. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> swatchId </span></span> </p> </td> 
   <td colname="col2"> <p>Immagine campione. </p> <p> <p>Nota:  Questa funzione è supportata in Adobe Scene7 Publishing System; non è supportato in Risorse Adobe Experience Manager. </p> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> L’identificatore del tipo di elemento del set di file multimediali può essere uno dei seguenti: </p> <p> 
     ...
     </ul> </p> <p> <p>Nota:  Questa funzione è supportata in Adobe Scene7 Publishing System; non è supportato in Risorse Adobe Experience Manager. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> modificatori </span></span> </p> </td> 
   <td colname="col2"> <p> Image Serving, comandi; <span class="codeph"> &amp; </span> e <span class="codeph"> = </span> i separatori devono essere codificati HTTP rispettivamente come <span class="codeph"> %26 </span> e <span class="codeph"> %3D </span>. </p> </td> 
