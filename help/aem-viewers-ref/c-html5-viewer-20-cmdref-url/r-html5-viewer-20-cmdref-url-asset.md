...
<table id="table_9B98C97485DD4DEB8A6ECBCE8DF6B886"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> ID risorsa del video singolo o del set di video adattivi. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_67E18F42E97C4AAAB0A2F67B7924765D"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Specifica una singola immagine o un set carosello. Applica la doppia codifica HTTP a qualsiasi carattere non sicuro presente nel nome dell’immagine o nel nome del set carosello. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
` asset=( *`mediaSet`* | ( *`video`*; *`swatchId`* | *`immagine`*; *`swatchId`* | *`setId`*; *`swatchId`*); *`ID`*;( *`video`*; *`swatchId`* | *`immagine`*; *`swatchId`* | *`setId`*; *`swatchId`*); *`ID`*;] [%3F *`modificatori`*]`
...
<table id="table_D31C8507C02A4452A79DEDDEC62EF2F5"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Video singolo o set video adattivo. </p> <p> <p>Nota: questa funzione è supportata in Adobe Dynamic Media Classic e non in Adobe Experience Manager Assets. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> immagine </span> </span> </p> </td> 
   <td colname="col2"> <p> Immagine singola. </p> <p> <p>Nota: questa funzione è supportata in Adobe Dynamic Media Classic e non in Adobe Experience Manager Assets. </p> </p> </td> 
  </tr> 
  <tr> 
...
Riferimento a un singolo set di file multimediali diversi:

```
 asset=Scene7SharedAssets/Mixed_Media_Set_Sample
```

Set di file multimediali diversi esplicito:
