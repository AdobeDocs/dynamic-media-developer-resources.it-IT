---
description: Note sulla versione di Dynamic Media Viewers (5.12.1)
solution: Experience Manager
title: Note sulla versione di Dynamic Media Viewers (5.12.1)
...
## Nuove funzioni e miglioramenti per la versione 5.12.1 {#section-f55c5ff7f6d0406c8739de4981dd7195}

* È stato aggiunto un nuovo visualizzatore per supportare i contenuti video 360.

## Correzioni di bug per la versione 5.12.1 {#section-50e7ea1e01dd4e1fa9c8b3e00eb002b4}

* È stata risolta la visualizzazione di una lunga durata video errata.
* Risolto un problema di visualizzazione a schermo intero in cui la pagina scorreva sui dispositivi Apple (in esecuzione su iOS 12 e versioni successive).

## Problemi noti e restrizioni per la versione 5.12.1 {#section-af67bc1734844f31a89a09004b558c6e}
