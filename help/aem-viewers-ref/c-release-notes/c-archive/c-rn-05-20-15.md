...
**IMPORTANTE:** l&#39;ultima versione di Firefox ora impedisce l&#39;esecuzione del plug-in del Flash Adobe sui siti Web per impostazione predefinita. Se è stato distribuito il lettore video Scene7 che utilizza il plug-in di Flash di Adobe sui sistemi desktop, sono disponibili le tre opzioni seguenti:
...
* I sottotitoli video richiedono un set di regole aziendali se ospitano una pagina HTML gestita da un server esterno che non è un server Dynamic Medie. Contatta l’assistenza tecnica dell’Adobe.
