...
seo-title: Note sulla versione di Scene7 Viewers 5.2.3
...
**IMPORTANTE:** L&#39;ultima versione di Firefox ora impedisce l&#39;esecuzione del plug-in Adobe Flash sui siti Web per impostazione predefinita. Se avete implementato il lettore video di Scene7 che utilizza il plug-in Adobe Flash nei sistemi desktop, avete le seguenti tre opzioni:
...
* Impostare il lettore video sulla `playback=native` modalità. In questo modo il video MP4 viene riprodotto progressivamente.

   Consultate [VideoPlayer.play](../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/c-html5-video-cmdref/r-html5-video-viewer-conf-attrib-videoplayer-playback.md#reference-13ec45db4cd4443b842f310153623221).
...
* [Le mappe immagine per l’eCatalog] si bloccano dopo l’utilizzo di modelli Javascript per il collegamento esterno su Internet Explorer 9.
...
* Lo stile CSS `display:none` sul `DIV` contenitore non è supportato. Questo include il `hide()` metodo Jquery.
