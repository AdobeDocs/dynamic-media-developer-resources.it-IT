...
seo-title: Note di rilascio dei visualizzatori (5.13.1)
...
* È stato aggiunto `RolloverKeyEvent.HREF_ACTIVATED` un evento per consentire al codice client di rispondere all’attivazione della mappa immagine in eCatalogViewer, eCatalogSearchViewer.
