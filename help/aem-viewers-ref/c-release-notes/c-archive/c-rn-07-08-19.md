...
* Aggiunto `RolloverKeyEvent.HREF_ACTIVATED` per consentire al codice client di rispondere all&#39;attivazione della mappa immagine in eCatalogViewer ed eCatalogSearchViewer.
