---
description: Note aggiornate sulla versione per  Adobe Dynamic Media Classic, parte della soluzione Adobe Experience Manager nell’Adobe Experience Cloud.
seo-description: Note aggiornate sulla versione per  Adobe Dynamic Media Classic, parte della soluzione Adobe Experience Manager nell’Adobe Experience Cloud.
...
Note aggiornate sulla versione per  Adobe Dynamic Media Classic, parte della soluzione Adobe Experience Manager nell’Adobe Experience Cloud.

## Note sulla versione di Dynamic Media {#topic-1f5af440670a42f3bbb662eb86a196c6}

Note aggiornate sulla versione per  Adobe Dynamic Media Classic, parte della soluzione [!DNL Adobe Experience Manager] in [!DNL Adobe Experience Cloud].
...
Per la documentazione completa, vedere [http://help.adobe.com/en_US/scene7/using/index.html](http://help.adobe.com/en_US/scene7/using/index.html)
...
* Video HTML5
   ...
   * I sottotitoli video richiedono un ruleset aziendale se l’hosting della pagina HTML è gestito da un server esterno (non da un server Dynamic Media). Per assistenza, contattate  Adobe.
