...
* Rimosso **Crea SPSAdmin** funzionalità utente di Gestione utente a causa di problemi di sicurezza.
...
* Accessibilità alla tastiera nei visualizzatori zoom di base di HTML5, visualizzatore a comparsa, visualizzatore di file multimediali diversi, visualizzatore a 360 gradi, visualizzatore zoom, visualizzatore video, visualizzatore carosello, visualizzatore di immagini interattive e visualizzatore video interattivo.
...
* Dispositivi mobili HTC
   ...
   * I dispositivi mobili HTC nei risultati dell’Adobe mostrano che l’impossibilità di disabilitare lo zoom nativo con le dita è una &quot;funzione&quot; del wrapper HTC UI (HTC Sense). Questo problema può causare lo zoom di tutta la pagina quando si utilizza il gesto &quot;pizzico per lo zoom&quot; sul visualizzatore. Suggerisci invece di usare il doppio tocco.
...
* Video HTML5
   ...
   * I sottotitoli video richiedono un set di regole aziendali se l’hosting della pagina HTML è gestito da un server esterno (non da [!DNL Dynamic Media] server). Per assistenza, contatta il supporto Adobe.
