...
Note aggiornate sulla versione di Adobe Dynamic Media Classic-part della soluzione Adobe Experience Manager in Adobe Experience Cloud.

## Note sulla versione di Dynamic Media {#topic-1f5af440670a42f3bbb662eb86a196c6}

Note aggiornate sulla versione di Adobe Dynamic Media Classic-part [!DNL Adobe Experience Manager] nella [!DNL Adobe Experience Cloud].
...
* Video HTML5
   ...
   * I sottotitoli video richiedono un set di regole aziendali se l’hosting della pagina HTML è gestito da un server esterno (non da un server Dynamic Media). Per assistenza, contatta il supporto Adobe.
