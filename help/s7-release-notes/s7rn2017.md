...
Per la documentazione completa, vedi [https://experienceleague.adobe.com/docs/dynamic-media-classic/using/intro/introduction.html#intro](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/intro/introduction.html#intro)
...
* Accessibilità da tastiera in Visualizzatore zoom di base di HTML5, Visualizzatore a comparsa, Visualizzatore di file multimediali diversi, Visualizzatore rotazione, Visualizzatore zoom, Visualizzatore video, Visualizzatore carosello, Visualizzatore immagine interattivo e Visualizzatore video interattivo.
...
* Video HTML5
   ...
   * I sottotitoli video richiedono un set di regole della società se la pagina HTML in hosting viene gestita da un server esterno (non da un server [!DNL Dynamic Media]). Per assistenza, contatta il supporto Adobe.
