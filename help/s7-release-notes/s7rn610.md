...
Note aggiornate sulla versione che descrivono le nuove funzioni, i miglioramenti e le correzioni per Adobe Scene7 Publishing System 6.10-part della soluzione Adobe Experience Manager in Adobe Experience Cloud.
...
* Opzione di risincronizzazione del server di catalogo in Convalida Publish IPS Classic rimossa.
...
**Nuove funzioni, miglioramenti e correzioni di bug per l&#39;SDK 2.9.2** del visualizzatore di Scene7 HTML5
...
* Le impostazioni di Publish non mostravano profili colore dalla società Scene7 Shared Assets.
...
* `clientAddressFilter` in formato non valido causava un&#39;eccezione dal server di catalogo durante l&#39;utilizzo delle impostazioni di Publish del server immagini di prova protetto.
...
* È stata aggiunta l’opzione di tipo Publish Image Server.
...
* **Avviso di fine del ciclo di vita dei visualizzatori di Flash** *A partire dal 31 gennaio 2017, Adobe Scene7 (ora Dynamic Media Classic) ha ufficialmente terminato il supporto per la piattaforma di visualizzazione di Flash.*
...
* Metadata Server e Similarity Search sono stati entrambi dichiarati obsoleti nel 2015 a causa della bassa adozione. Quando viene annunciata la data di scadenza ufficiale per la rimozione, il supporto tecnico Adobe ha avvisato i clienti interessati.
