...
<table id="table_65BA9F98D1D041109A44B1C130EF4EFA"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>La scheda include un'impostazione di qualità di stampa <span class="uicontrol"> di </span> che consente di specificare la dimensione massima dell'immagine inviata alla stampante. Il valore predefinito è <span class="codeph"> 1000 </span>. </p> </td>
  </tr>
  <tr> 
...
<table id="table_023203E3CC484F59A350C3C333EF817F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Elenco a discesa modalità zoom <span class="uicontrol"> di </span> </p> </td> 
   <td colname="col2"> <p>Consente di configurare il tipo di animazione di zoom da utilizzare. Nella barra a sinistra, fare clic su <span class="uicontrol"> Caratteristiche visualizzatore </span> per accedere alle seguenti opzioni della modalità zoom <span class="uicontrol"> di </span> dall'elenco a discesa: </p> <p> 
...
* È stato rimosso l&#39;utilizzo dello stile di visibilità:visible nei componenti SDK.
...
* Fisso - ZoomView - zoom e scorrimento interrotti su IE se la larghezza massima:100% è definita per IMG nel CSS.
* Sono stati aggiunti ulteriori eventi di stato.
