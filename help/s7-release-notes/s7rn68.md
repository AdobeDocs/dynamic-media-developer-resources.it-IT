...
* Converti e-mail password dimenticata da HTML a testo normale per evitare l’inserimento in blacklist.
...
* Problema corretto: non `selectSwatch` viene attivato se incorporato nella `initViewer()` funzione.
