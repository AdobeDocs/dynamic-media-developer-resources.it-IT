...
* [Caratteristiche salienti della versione di Scene7 Publishing System 6.9](s7rn69.md#section-2ed72b7902be4509876d81f25b5632ce)
...
**Nuove funzioni, miglioramenti e correzioni di bug per l&#39;SDK 2.8.1** del visualizzatore di Scene7 HTML5
...
**Nuove funzioni, miglioramenti e correzioni di bug per i visualizzatori Image Server di Dynamic Medie 5.1.1**
...
Consulta anche la [Guida di riferimento per i visualizzatori di Scene7](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html?lang=en).
...
* È stato aggiunto il supporto per la visualizzazione di immagini strette utilizzando il modificatore `highlightmode` per il visualizzatore a comparsa di HTML5
* È stato aggiunto il supporto per controllare l&#39;upscaling delle immagini utilizzando il modificatore `zoomfactor` per il visualizzatore a comparsa di HTML5.
...
* L&#39;immagine del poster potrebbe contenere un errore di &quot;dimensioni massime&quot;. Di conseguenza, devi aumentare l’impostazione del limite per Image Server Publish.
