---
description: Note aggiornate sulla versione che descrivono le funzioni, le correzioni e i miglioramenti implementati in Adobe Scene7 Publishing System 6.9, componente della soluzione di Adobe Experience Manager  nell’Adobe Marketing Cloud .
seo-description: Note aggiornate sulla versione che descrivono le funzioni, le correzioni e i miglioramenti implementati in Adobe Scene7 Publishing System 6.9, componente della soluzione di Adobe Experience Manager  nell’Adobe Marketing Cloud .
...
Note aggiornate sulla versione che descrivono le funzioni, le correzioni e i miglioramenti implementati in Adobe Scene7 Publishing System 6.9, componente della soluzione di Adobe Experience Manager  nell’Adobe Marketing Cloud .

## Note sulla versione di Scene7 Publishing System 6.9 (ottobre 2014) {#topic-1d3011ecca71488abe0d8156a9fc1b97}

Note aggiornate sulla versione che descrivono le funzioni, i miglioramenti e le correzioni più recenti per [!DNL Adobe Scene7 Publishing System] 6.9 parti della soluzione di Adobe Experience Manager  nel [!DNL Adobe Marketing Cloud].
...
* I sottotitoli video sono ora disponibili nei visualizzatori `Universal_HTML5_MixedMedia_dark` e `Universal_HTML5_MixedMedia_light` visualizzatori integrati. Consultate [Aggiunta di sottotitoli a video](https://docs.adobe.com/content/help/en/dynamic-media-classic/using/video/adding-captions-video.html).
...
Consultate anche la guida [di riferimento dei visualizzatori di](https://docs.adobe.com/content/help/en/dynamic-media-developer-resources/library/home.html)Scene7.

* Supporto aggiornato per Internet Explorer 11
* I visualizzatori sono stati modificati per utilizzare il tracciamento di Adobe  Analytics e non le richieste di tracciamento di pagina
