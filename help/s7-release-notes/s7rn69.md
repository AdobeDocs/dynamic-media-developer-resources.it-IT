...
**Nuove funzioni, miglioramenti e correzioni di bug per i visualizzatori Image Server di Dynamic Media 5.1.1**
...
* I sottotitoli video richiedono un set di regole aziendali se ospitano una pagina HTML gestita da un server esterno che non è un server Scene7. Contatta il supporto tecnico Adobe per assistenza.
...
* Metadata Server e Similarity Search sono stati resi obsoleti nel 2015 a causa della bassa adozione. Quando viene annunciata la data di scadenza ufficiale per la rimozione, il supporto tecnico Adobe ha avvisato i clienti interessati.
